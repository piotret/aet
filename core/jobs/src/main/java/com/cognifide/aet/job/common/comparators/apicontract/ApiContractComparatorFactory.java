...
@Component
public class ApiContractComparatorFactory implements ComparatorFactory {
    ...
    public final String getType() {
        return ApiContractComparator.COMPARATOR_TYPE;
    }

    @Override
    public final String getName() {
        return ApiContractComparator.COMPARATOR_NAME;
    }
    ...
    public ComparatorJob createInstance(Comparator comparator,
        ...
        final ApiContractComparator sourceComparator = new ApiContractComparator(artifactsDAO,
